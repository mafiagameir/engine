 ...
 */
public class ElectionFinishedCommandContext extends CommandContext {
    private final boolean onTimer;

    public ElectionFinishedCommandContext(InterfaceContext interfaceContext,
                                             Game game, boolean onTimer) {
