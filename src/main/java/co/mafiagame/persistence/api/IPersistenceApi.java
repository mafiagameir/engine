...
public interface IPersistenceApi {
    ...
    Account saveAccount(String userName, String firstName, String lastName, InterfaceType interfaceType, String userId);

    MessageHolder.Lang getLang(String userId);

    void setLang(String userId, MessageHolder.Lang lang);
}
